...
/**
 * Ranking FIFA das 48 seleções (base abril/2026; menor = melhor). Usado SÓ
 * como penúltimo critério de desempate dos 8 melhores 3ºs (3C). Chaveado
 * por `teams.nome` (= Selecao.nome). O seed popula `teams.ranking_fifa`.
 */
export const RANKING_FIFA: Record<string, number> = {
